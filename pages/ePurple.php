...
$_SESSION['ePurple'] = true; //Lilanes Etui wird gekauft
?>
...
<head>
  <meta charset="utf-8">
  <title>Purple Etui</title>
  <link rel="stylesheet" href="../css/style.css">
</head>

<body>
  <h1>Bestelung : Etui</h1>
  <img id="ePurple" src="../img/Etui.jpg" alt="etui">
...
//          $_SESSION['checkedBoxes'] = $_POST['checkbox'];
          ...
          echo "Es sind ".$_SESSION['ePurpleCount']." checkboxen ausgewählt";
